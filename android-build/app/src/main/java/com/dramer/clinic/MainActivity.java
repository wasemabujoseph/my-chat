...
public class MainActivity extends Activity {
    ...
    private void refreshStatus(){
        ...
        if(j!=null&&!j.future.isDone())status.setText("Automation: "+j.phase);
    ...
    private void buildUi(){
        ...
        root.addView(tv("Android v5.1 Standalone Automation Test",15));
    ...
    private void runAnalysis(){
        ...
        try{
            result.setText("جاري فتح "+provider.getSelectedItem().toString()+" وإرسال الحالة...");
